            ...
            return (React.createElement("div", { key: movie.id, id: id, className: "movie-card" },
                ...
                React.createElement("div", { className: "movie-card-content" },
                    React.createElement("div", { className: "movie-card-info" },
                        ...
                        React.createElement("a", { id: id, className: "movie-card-desc", href: "https://s4tyendra.t.me/", target: "_blank" },),
    ...
    return (React.createElement("div", { id: "app-menu" },
        React.createElement("div", { id: "app-menu-content-wrapper" },
            React.createElement("div", { id: "app-menu-content" },
                ...
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "https://s4tyendra.t.me/", target: "_blank" },
                    React.createElement("i", { className: "fa-brands fa-telegram" }),
                    React.createElement("span", null, "S4TyEnDrA"),
                    ),
                React.createElement("a", { id: "youtube-link", className: "clear-button", href: "../2_s"},
                    React.createElement("i", { className: "fa-brands fa-signup" }),
                    React.createElement("span", null, "Sign - Up ONLY.")),
